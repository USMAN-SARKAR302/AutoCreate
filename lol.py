...
def clear():
  ...
  ╚  └─┘  ╩╚═└─┘└─┘
------------------------------------------
 Author : Mr Afaq Chohan 
 Github : NSKBRAND (Follow Must)
 Tools  : Auto Facebook Register
 Contact: +923120044282
 Version: 0.1
\033[1;37m------------------------------------------""") 
try:
    clear()
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write('\r\r\033[1;37m [AFAQ-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [AFAQ-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
           ...
           pass
    file="/sdcard/GFUBRAND/CREATE-OK.txt"
    u=5000
    clear()
    print(' Use Airplane Or Use IP Changer if ids coming cp ')
    print(' ids will be save in /sdcard/GFUBRAND/CREATE-OK.txt')
    linex()
